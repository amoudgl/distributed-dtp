...
class VanillaBaselineModel(LightningModule, ABC):
    ...
    def __init__(
        ...
        self.hp: VanillaBaselineModel.HParams = hparams
    ...
    def shared_step(
        ...
        print(f"[{batch_idx}] {phase}/accuracy", self.accuracy(probs, y))
        print(f"[{batch_idx}] {phase}/F_loss", loss.item())
